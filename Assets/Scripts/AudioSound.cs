...
public class AudioSound : MonoBehaviour
{
    ...
    void OnGUI()
    {
        if(blob1.activeSelf == true)
        {
            ...
            pitchValue = GUI.HorizontalSlider(new Rect(1000,400,100,500), pitchValue, low, high); 
        ...
        {
            pitchValue = GUI.HorizontalSlider(new Rect(750,400,100,500), pitchValue, low, high); 
            audioSource.pitch = pitchValue; 
        }
    }
}
